/**
 * E2E test that verifies Codefluff can read and use knowledge.md from the project.
 *
 * Starts Codefluff in tmux, creates a knowledge.md file with a unique keyword,
 * asks Codefluff about that keyword, and verifies it responds using the knowledge.
 *
...
describe('Codefluff: Knowledge Files', () => {
